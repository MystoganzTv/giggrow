...
//  real driver opened GigGrow and saw $1,482.60 of somebody else's earnings
...
enum Seed {
    ...
    static func completeOnboarding(
        ...
        let year = Calendar.gigGrow.component(.year, from: .now)
...
extension Seed {
    ...
    static func loadDemoData(_ context: ModelContext) {
        ...
        let vehicle = VehicleRecord(
            ...
            odometerAsOf: Calendar.gigGrow.startOfWeek(for: .now),
    ...
    static func demoService(baseOdometer: Int) -> [ServiceRecord] {
        [
            ...
            ServiceRecord(name: "Registration",
                          dueOn: Calendar.gigGrow.date(from: DateComponents(year: 2027, month: 3, day: 1)),
