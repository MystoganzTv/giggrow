        ...
        NavigationStack {
            ...
            .toolbar {
                ...
                ToolbarItem(placement: .confirmationAction) {
                    Button("Save") { save() }
                        .foregroundStyle(canSave ? GG.Palette.violet300 : GG.Ink.muted)
                        .disabled(!canSave)
                }
            }
        }
            ...
            VStack(spacing: 0) {
                HStack {
                    ...
                    TextField("0.0", text: $milesText)
                        ...
                        .ggText(.system(size: 17, weight: .semibold))
                        .frame(maxWidth: 120)
                }
                .padding(.vertical, 14)
        ...
        return Button {
            ...
            Text(option.label)
                ...
                .overlay(Capsule().strokeBorder(
                    isSelected ? Color.clear : GG.Surface.stroke, lineWidth: 1))
        }
        .buttonStyle(.plain)
    }
            ...
            HStack {
                VStack(alignment: .leading, spacing: 3) {
                    ...
                    Text(purpose.isDeductible ? Money.cents(miles * MileageRates.rate(on: date)) : "$0.00")
                        .ggText(.system(size: 22, weight: .semibold), tracking: -0.5,
                                color: purpose.isDeductible ? GG.Palette.mint : GG.Ink.tertiary)
                }
                Spacer(minLength: 8)
